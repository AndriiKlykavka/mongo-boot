...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // Деталі
        Collection<Part> givenPartsList = List.of(
                new Cube(450, 0.1),
                new Cube(300, 0.2),
                new Sphere( 150, 0.3),
        ...
        // Коробки
        Collection<Box> availableBoxesList = List.of(
                new Box(700),
                new Box(500),
                new Box(500),
                new Box(500),
        ...
        int boxPackagingPricePerMeter = 40;

        new PartsProcessor().packageParts(givenPartsList, availableBoxesList, boxPackagingPricePerMeter);
    }
}
